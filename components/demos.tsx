        ...
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl" style={{ border: '1px solid #efefef' }}>
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Scim</h4>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl" style={{ border: '1px solid #efefef' }}>
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Papeo</h4>
...
{/* row two */}
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">CiteSee</h4>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">PaperPlain</h4>
              <p className="text-gray-600 text-center mb-2">Making Medical Research Papers Approachable to Healthcare Consumers</p>
              <p className="text-gray-600 text-center" style={{ margin: '0 -10px' }}>
                <span className="inline-flex items-center rounded-md bg-gray-50 px-2 py-1 text-xs font-medium text-gray-600 ring-1 ring-inset ring-gray-500/10 mr-1">Demo Video</span>
                <span className="inline-flex items-center rounded-md bg-green-50 px-2 py-1 text-xs font-medium text-green-700 ring-1 ring-inset ring-green-600/20">Research Paper</span>
              </p>
