...
export default function Paper({paper}: {paper: PaperType}) {
  ...
  return (
    <span style={{ display: 'inline-block' }}>
      {(paper.externalIds.CorpusId === 256868353 || paper.externalIds.CorpusId === 248420091 || paper.externalIds.CorpusId === 239011922) ? <span style={{ fontWeight: 'bold' }}>🏆 Best Paper Award<br /></span> : null}
